...
import com.example.jiamiaohe.gamehelper.picture.recognition.ImageAnalyzeActivity;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CustomAdapter.this.c, ImageAnalyzeActivity.class);
                intent.putExtra("path", s.getUri().getPath());
