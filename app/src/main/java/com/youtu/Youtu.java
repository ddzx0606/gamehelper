...
public class Youtu {
	...
	private void GetBase64FromResourceId(int id, StringBuffer base64)
			throws IOException {
	...
	private void GetBase64FromBitmap(Bitmap bitmap, StringBuffer base64)
			throws IOException {
	...
	//hjm add
	public JSONObject DetectFaceWithResourceId(int id,int mode) throws IOException,
			JSONException, KeyManagementException, NoSuchAlgorithmException {

		StringBuffer image_data = new StringBuffer("");
		JSONObject data = new JSONObject();

		GetBase64FromResourceId(id, image_data);
		data.put("image", image_data.toString());
		data.put("mode", mode);
		JSONObject respose =m_not_use_https?SendHttpRequest(data, "api/detectface"):SendHttpsRequest(data, "api/detectface");
	...
	public JSONObject DetectFaceWithBitmap(Bitmap bitmap,int mode) throws IOException,
			JSONException, KeyManagementException, NoSuchAlgorithmException {

		StringBuffer image_data = new StringBuffer("");
		JSONObject data = new JSONObject();

		GetBase64FromBitmap(bitmap, image_data);
		data.put("image", image_data.toString());
		data.put("mode", mode);
		JSONObject respose =m_not_use_https?SendHttpRequest(data, "api/detectface"):SendHttpsRequest(data, "api/detectface");
	...
	//hjm add
	public JSONObject GeneralOcrWithBitmap(Bitmap bitmap) throws IOException,
			JSONException, KeyManagementException, NoSuchAlgorithmException {
		JSONObject data = new JSONObject();
